...
mkdir ${sample}_ichorCNA_test_0_4_0

Rscript /home/diagnostics/pipelines/ichorCNA-0.4.0/scripts/runIchorCNA.R --id $sample \
  --libdir /home/diagnostics/pipelines/ichorCNA-0.4.0/ --WIG /home/pipelines/NextSeq_mutation_detector_leukemia/scripts/ichorCNA/${sample}.tumor.wig --ploidy "c(2)" \
  ...
  --scStates "c()" --txnE 0.9999 --txnStrength 10000 --outDir ./${sample}_ichorCNA_test_0_4_0
